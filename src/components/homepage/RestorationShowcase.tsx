...
export default function RestorationShowcase() {
  ...
  return (
    <Box sx={{ minHeight: { xs: "auto", lg: "calc(100vh - 72px)" }, display: "flex", flexDirection: "column", justifyContent: "center", py: { xs: 8, md: 12 }, bgcolor: 'background.default', transition: 'background-color 0.3s ease' }}>
